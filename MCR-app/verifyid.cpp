...
void verifyid::on_pushButton_submit_clicked()
{
    ...
    {
//        out<<"Licence,";
        ID1 = ui->lineEdit_1L1->text();
        ID2 = ui->lineEdit_1L2->text();
        IDSearch = ID1 + ',' + ID2;
    }
    if(ui->radioButton_cer->isChecked())
    {
//        out<<"Birth certificate,";
        ID1 = ui->lineEdit_2C1->text();
        ID2 = ui->lineEdit_2C2->text();
        IDSearch = ID1 + ',' + ID2;
    }
    if(ui->radioButton_ppt->isChecked())
    {
//        out<<"Passport,";
        ID1 = ui->lineEdit_3P1->text();
        ID2 = ui->lineEdit_3P2->text();
        IDSearch = ID1 + ',' + ID2;
    }
    if(ui->radioButton_cc->isChecked())
    {
//        out<<"Citizenship certificate,";
        ID1 = ui->lineEdit_4CC1->text();
        ID2 = ui->lineEdit_4CC2->text();
        IDSearch = ID1 + ',' + ID2;
    }
